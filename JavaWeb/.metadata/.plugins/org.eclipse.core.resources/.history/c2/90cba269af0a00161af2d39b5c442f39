...
<body>
	...
	<div id="login">
	<div class="Un">ÓÃ»§Ãû£º<input name="userName" type="text" /></div>
	<div class="Pwd">ÃÜ Âë£º<input name="userPassword" type="password" /></div>
	<div class="Btn"><input type="submit" value="µÇÂ¼" onclick="return check()"/></div>
	</div>
	</form>
	...
	<%
		if(loginUser.getError() !=null){
			out.print("<script type=\"text/javascript\">alert(\"ÓÃ»§Ãû»òÃÜÂë´íÎó£¡\");</script>");
		}
	%>
</body>
</html>