...
public class GetVoteResultServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println(this.parseHtml("小品《水下除夕夜》",ballotcount,chuxiye));
		out.println(this.parseHtml("小品《不差钱》",ballotcount,buchaqian));
		out.println(this.parseHtml("歌曲《本草纲目》",ballotcount,bencaogangmu));
		out.println(this.parseHtml("歌曲《祖国颂》",ballotcount,zuguosong));
	}
	...
	private String parseHtml(String option,Integer ballotcount,Integer ballot){
		...
		sb.append("<td width=400 height=40>"+option + " - " +ballot+ "票("+ percent + "%)");
		sb.append("<div style='background-color:#cccccc;width:"+percent+"%'>&nbsp;</div>");
		sb.append("</td>");
		sb.append("</tr>");
		return sb.toString();
	}
