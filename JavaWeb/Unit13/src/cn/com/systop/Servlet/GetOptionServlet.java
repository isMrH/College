...
public class GetOptionServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		buffer.append("<option val=\"chuxiye\">小品《水下除夕夜》</option>");
		buffer.append("<option val=\"buchaqian\">小品《不差钱》</option>");
		buffer.append("<option val=\"bencaogangmu\">歌曲《本草纲目》</option>");
		buffer.append("<option val=\"zuguosong\">歌曲《祖国颂》</option>");
		buffer.append("</options>");
		...
		if(init==null){
			...
			application.setAttribute("buchaqian",0);
