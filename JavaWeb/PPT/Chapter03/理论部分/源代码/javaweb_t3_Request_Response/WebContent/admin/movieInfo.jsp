...
<%@ page import="cn.com.systop.jspt05.entity.Type" %>
<%@ page import="cn.com.systop.jspt05.dao.TypeDAO" %>
<%@ page import="cn.com.systop.jspt05.dao.impl.TypeDAOImpl" %>
<%
			...
			<div class="c_content"> 		  		
				<ul style="color:red;list-style-type:circle;">
			 	...
			 	<table border="0">
			        ...
			        <tr>
			    		<th>电影图片</th>
			       		<td><input type="text" name="image" onblur="setMoviesPic(this.value);" value="images/movies/"/><span style="color:red;">&nbsp;*在"images/movies/"后录入图片名称即可</span></td>
			        </tr>
			        <tr>
			    		<th>电影定价</th>
				...
				<div class="button_bar">
					<button onclick="doSubmit();">&nbsp;&nbsp;&nbsp;提  交&nbsp;&nbsp;&nbsp;</button>
		        </div>
