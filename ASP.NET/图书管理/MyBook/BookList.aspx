...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContent" Runat="Server">
      ...
      | <INPUT class=anniu id=ctl00_cphContent_btnPrice style="BORDER-RIGHT: seagreen 1px solid; BORDER-TOP: seagreen 1px solid; FONT-WEIGHT: normal; FONT-SIZE: 12px; BORDER-LEFT: seagreen 1px solid; WIDTH: 57px; COLOR: black; BORDER-BOTTOM: seagreen 1px solid; HEIGHT: 16px; BACKGROUND-COLOR: #c0ffc0" type=submit value=价格 name=ctl00$cphContent$btnPrice><uc1:Control 
              ID="Control1" runat="server" />
          </DIV></DIV></DIV>
      <DIV class=STYLE4>
            ...
            <TABLE>
              ...
              <TR>
                <TD style="FONT-SIZE: small" align=left><SPAN 
                  ...
                  Lajoie对C++标准深入理解的完美结合，更加入了C++先驱Barbarasss E. 
