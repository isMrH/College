<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="BookList.aspx.cs" Inherits="BookList" Title="图书列表页" %>
    ...
    <asp:DataList ID="dlBooks" runat="server">
        <ItemTemplate>
            <table>
                <tr>
                  <td rowspan="2">
                     <a  href="bookshow.aspx?id=<%# Eval("Id")%>">
                  ...
                  <td style="FONT-SIZE: small; COLOR: red" width="650">
                    <a href="bookshow.aspx?id=<%# Eval("Id")%>" name="link_prd_name" target="_blank" class="booktitle" id="link_prd_name"><%# Eval("Title") %></a> 
                  </td>
                </tr>
                <tr>
                  <td align="left">
